...
show_post_install_instructions() {
    ...
    echo -e "   ${YELLOW}export ZSH_OPENAI_API_KEY=\"your-api-key\"${NC}                        # For OpenAI"
    echo -e "   ${YELLOW}export ZSH_AZURE_OPENAI_API_KEY=\"your-api-key\"${NC}                  # For Azure OpenAI"
    echo -e "   ${YELLOW}export ZSH_AZURE_OPENAI_RESOURCE_NAME=\"your-resource-name\"${NC}      # For Azure OpenAI"
    echo -e "   ${YELLOW}export ZSH_AZURE_OPENAI_DEPLOYMENT_NAME=\"your-deployment-name\"${NC}  # For Azure OpenAI"
    echo -e "   ${YELLOW}export ZSH_ANTHROPIC_API_KEY=\"your-api-key\"${NC}                     # For Anthropic"
    echo -e "   ${YELLOW}export ZSH_GEMINI_API_KEY=\"your-api-key\"${NC}                        # For Google Gemini"
    echo -e "   ${YELLOW}export ZSH_DEEPSEEK_API_KEY=\"your-api-key\"${NC}                      # For DeepSeek"
    echo ""
